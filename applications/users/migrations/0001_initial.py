# Generated by Django 3.2.6 on 2021-08-17 01:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genero', models.CharField(blank=True, choices=[('M', 'Masculio'), ('F', 'Femenino'), ('O', 'Otros')], max_length=1)),
                ...
                ('categoria', models.ManyToManyField(blank=True, to='users.Category')),
